...
RANGE_UNALLOCATED_1 = Range(
    start=10, end=9_999_999, label="Unallocated 1 (not in use)"
)
...
RANGE_UNALLOCATED_2 = Range(
    start=3_113_000_000, end=3_199_999_999, label="Unallocated 2 (not in use)"
)
...
RANGE_UNALLOCATED_3 = Range(
    start=8_600_000_000, end=8_999_999_999, label="Unallocated 3 (not in use)"
)
...
REGION_RESERVED = Region(
    label="Reserved and not issued",
    tags=["reserved"],
    ranges=[RANGE_RESERVED]
)
