...
By default it is skipped. Include it by invoking pytest with the --runslow option
"""
import os.path
import csv
import sys
...
def test_with_large_numbers_of_random_nhs_numbers():
    with open('local-test-data/testdata-909090-valid-nhs-numbers.csv', newline='', encoding='utf-8-sig') as csvfile:
        testdata = []
